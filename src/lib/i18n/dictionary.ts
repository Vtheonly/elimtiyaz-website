...
const fr: Dict = {
  ...
  "auth.signin.or": "ou",
  "auth.signin.mock": "Connexion Admin (Mock)",
  "auth.signin.mockHint": "Mode développement — compte administrateur temporaire",
...
const ar: Dict = {
  ...
  "auth.signin.or": "أو",
  "auth.signin.mock": "دخول المدير (تجريبي)",
  "auth.signin.mockHint": "وضع التطوير — حساب مدير مؤقت",
...
const en: Dict = {
  ...
  "auth.signin.or": "or",
  "auth.signin.mock": "Admin Login (Mock)",
  "auth.signin.mockHint": "Development mode — temporary administrator account",
